Log_Name='ResNet50_CropNet_transferToTargetDomain_RAFtoFER2013'
#Resume_Model='/media/z/ae609a98-67c3-41ce-beed-791c5c3bf738/CD_FER_CODE/preTrainedModel/ResNet50_CropNet_GCNwithIntraMatrixAndInterMatrix_useCluster_withoutAFN_trainOnSourceDomain_RAFtoExpW.pkl'
#Resume_Model='./exp_2/CK+/all'
Resume_Model='/media/z/ae609a98-67c3-41ce-beed-791c5c3bf738/CD_FER_CODE/FIXMATCH_change/exp_2/tao=1.6/ck+/1683544514/ResNet50_CropNet_transferToTargetDomain_RAFtoFER2013.pkl'
OutputPath='./exp'
GPU_ID=0
Backbone='ResNet50'
useAFN='False'
