...
class Backbone(nn.Module):
    def __init__(self, numOfLayer, useIntraGCN=True, useInterGCN=True, useRandomMatrix=False, useAllOneMatrix=False, useCov=False, useCluster=False):   
        ...
        self.SourceMean = CountMeanOfFeatureInCluster(64)
        self.TargetMean = CountMeanOfFeatureInCluster(64)

        self.SourceBN = BatchNorm1d(64)
        self.TargetBN = BatchNorm1d(64)
    ...
    def classify(self, imgs, locations):
        ...
        # if self.training:
        #     feature = self.SourceMean(global_feature)
        ...
        pred_global = self.classifiers[0](global_feature)
        feature_global = self.l2norm(global_feature)
